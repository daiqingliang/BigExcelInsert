...
/**
 * 名称: ReadBigExcel.java<br>
 * 描述: <br>
 * 类型: JAVA<br>
 * 最近修改时间:2018年9月7日 上午10:00:52<br>
 * 
 * @since 
 * @author daiql
 */
public class ReadBigExcel extends DefaultHandler {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("**********************************************");
            ReadBigExcel reader = new ReadBigExcel();
            reader.process("C:/Users/daiql/Desktop/temp_test.xlsx");
            result = reader.getList();
